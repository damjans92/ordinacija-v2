...
const NavbarLinksRight = ({ navLinks, pathname }: NavbarLinksProps) => {
  return (
    <nav className="hidden lg:flex flex-1 justify-end font-redhat font-extrabold text-sm tracking-widest ">
